 ...
 * Affiche la nav latérale + topbar.
 */
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="<?= $currentPage === 'properties' ? 'active' : '' ?>">
                <a href="/admin/properties.php">
                    <i class="fas fa-home"></i>
                    <span>Biens Immobiliers</span>
                </a>
            </li>
            <li class="<?= $currentPage === 'property-form' ? 'active' : '' ?>">
                <a href="/admin/property-form.php">
            ...
            <li class="<?= $currentPage === 'user-form' ? 'active' : '' ?>">
    ...
    <div class="sidebar-user">
        <div class="user-avatar">
            <?= strtoupper(substr($currentUser['email'], 0, 2)) ?>
        </div>
        <div class="user-info">
            <span class="user-name"><?= htmlspecialchars($currentUser['email'], ENT_QUOTES | ENT_HTML5) ?></span>
            <span class="user-role <?= $currentUser['role'] === 'admin' ? 'role-admin' : 'role-agent' ?>">
                <?= ucfirst($currentUser['role']) ?>
            </span>
        </div>
        <a href="/admin/logout.php" class="logout-btn" title="Déconnecter">
...
<main class="main-content" id="mainContent">
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            <a href="/index.html" target="_blank" class="topbar-site-link">
    ...
    <!-- Content area (fermé dans admin_footer.php) -->

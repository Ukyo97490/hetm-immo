<?php
/**
 * H&M Immobilier — Activer / Désactiver un utilisateur
 * POST uniquement. Admin only.
 */
...
if ($userId === null || !in_array($action, ['activate', 'deactivate'], true)) {
...
if ($success) {
    ...
    audit_log($_SESSION['user_id'], $action . '_user', "user:$userId",
              "Utilisateur {$user['email']} $label");

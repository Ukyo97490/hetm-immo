<?php
/**
 * H&M Immobilier — Suppression d'un Bien
 * Méthode : POST uniquement.
 * Vérifie : CSRF, authentification, droits de gestion.
 */
...
if ($propertyId === null) {
    $_SESSION['flash_error'] = 'ID de bien invalide.';
    header('Location: /admin/properties.php');
    exit;
}
...
// Supprime le bien (et ses images)
$success = $model->delete($propertyId, $_SESSION['user_id'], is_admin());

if ($success) {
    audit_log($_SESSION['user_id'], 'delete_property', "property:$propertyId",
              "Bien supprimé: " . $property['title']);

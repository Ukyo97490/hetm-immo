...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') { http_response_code(405); header('Location: properties.php'); exit; }
csrf_check();

$propertyId = sanitize_int($_POST['property_id'] ?? null);
if ($propertyId === null) { $_SESSION['flash_error']='ID de bien invalide.'; header('Location: properties.php'); exit; }
